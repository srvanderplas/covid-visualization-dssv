...
\begin{figure*}
	\includegraphics[width = 0.98\textwidth]{who_totalcases_choro}
...
\begin{figure}
\centering
\includegraphics[width=.3\linewidth]{NYT-heatmap-crop}
\includegraphics[width=.3\linewidth]{NYT-heatmap-crop3}
