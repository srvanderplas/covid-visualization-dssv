...
<<plot_corana, dependson = "corana", echo = TRUE>>=
...
<<ca_biplot_dims23, dependson = "plot_corana", echo = TRUE, fig.width = 6, fig.height = 6, out.width = "10cm", fig.align = "center", fig.cap = "Biplot of a correspondence analysis on word counts used in descriptions of data science by different web sources in dimensions 2 and 3.">>=
